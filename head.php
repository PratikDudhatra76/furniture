        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class=""><a href="all_product.php">Shop</a>
                    </li>
                    <li class=""><a href="contact.php">Contact US</a>
                    </li> 
                    <li class=""><a href="About.php">About</a>
                    </li>
                    <li class=""><a href="login.php">Login/Register</a>
                    </li>
                    <li class=""><a href="admin/index.php">Admin</a>
                    </li>
                    <li>
                        <a href="http://localhost/furn/customer-account.php">My Account</a>
                    </li>           
