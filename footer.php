            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <p><strong>Samako Funiture Investments.</strong>
                            <br>Malaba Eldoret Road
                            <br>Kitale
                            <br>
                            <strong>Kenya</strong>
                        </p>
 ...
 _________________________________________________________ -->
        <div id="copyright">
            <div class="container">
                <div class="col-md-6">
                    <p class="pull-left">© 2023-2024 Furniture (pratik_dudhatra)</p>

                </div>
                <div class="col-md-6">
                   <!-- <p class="pull-right">Design By <a href="https://starixcoms.000webhostapp.com/">Starcoms Computers</a>
