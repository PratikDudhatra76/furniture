...
<html lang="">
      ...
      <div class="row display-table-row">
        ...
        <div id="content">
          <header class="clearfix">
            ...
            <button  type="button" class="btn btn-primary btn-xs pull-right">Add New Product</button>
          </header>
  ...
  <tr>
    ...
    <td><a class="btn btn-xs btn-warning"href="index.php?edit_pro=<?php echo $pro_id; ?>">Edit</a>
